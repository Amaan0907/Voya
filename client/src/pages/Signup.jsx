        ...
        <div className="min-h-screen w-full max-w-[100vw] overflow-x-hidden flex flex-col bg-[#fdf3ee]">
            <div className="flex flex-1 flex-col md:flex-row w-full">
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url('https://images.unsplash.com/photo-1504598318550-17eba1008a68?q=80&w=686&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
                    }}
                >
